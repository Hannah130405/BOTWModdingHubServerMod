...
public class ModBlocks {
    public static final Block GAMING_MONITOR = registerBlock("gaming_monitor",
            new Block(FabricBlockSettings.of(Material.METAL).luminance(3).strength(1f)), ModItemGroup.DECORATION);
    public static final Block SUSHI_PLATE = registerBlock("sushi_plate",
            new Block(FabricBlockSettings.of(Material.GLASS).strength(0.5f)), ModItemGroup.DECORATION);
